...
```python
from pyneoforge import block, config, creative_tab, food, item, pickaxe, shaped_recipe, sword
...
sword("example_sword", display_name="Example Sword", tier="iron", attack_damage=3.0, attack_speed=-2.4, texture_file="textures/example_sword.png")
pickaxe("example_pickaxe", display_name="Example Pickaxe", tier="iron", texture_file="textures/example_pickaxe.png")
